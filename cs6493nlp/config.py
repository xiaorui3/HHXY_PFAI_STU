...
# train_src_file_nqg = "./squad/para-train.txt"
# train_trg_file_nqg = "./squad/tgt-train.txt"
# # dev file
# dev_src_file_nqg = "./squad/para-dev.txt"
# dev_trg_file_nqg = "./squad/tgt-dev.txt"
# # test file
# test_src_file_nqg = "./squad/para-test.txt"
# test_trg_file_nqg = "./squad/tgt-test.txt"
# # embedding and dictionary file
# embedding_nqg = "./data/embedding_nqg.pkl"
# word2idx_file_nqg = "./data/word2idx_nqg.pkl"
